...
for ic=1:5;
	...
	Plot_results_tex(cx1, cy1, ey1, xlab, ylab, 'bs', 'b', ymin, ymax, xmin, xmax);
	Plot_results_tex(cx2, cy2, ey2, xlab, ylab, 'bd', 'b', ymin, ymax, xmin, xmax);
	Plot_results_tex(cx3, cy3, ey3, xlab, ylab, 'bo', 'b', ymin, ymax, xmin, xmax);
	...
	myprintplot(['O_' num2str(ic) '_fit' ]);
